...
y_maestro_interp = interp1d(
	...
	\subsection{Resultados del Barrido de Parámetros}
	...
	\subsubsection{Barrido del Parámetro $a$ de Rössler}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.75\textwidth]{hamming_vs_a.png}
		\caption{Distancia de Hamming vs parámetro $a$ de Rössler}
		\label{fig:hamming_a}
	\end{figure}
	
	\subsubsection{Barrido del Parámetro $b$ de Rössler}
	
	Se varió $b$ en el rango $[0.02,\, 1.00]$ con paso de $0.02$ (50 puntos), bajo el mismo criterio de precisión para el valor original.
	
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.75\textwidth]{hamming_vs_b.png}
		\caption{Distancia de Hamming vs parámetro $b$ de Rössler}
		\label{fig:hamming_b}
	\end{figure}
	
	\subsubsection{Barrido del Parámetro $c$ de Rössler}
	
	Se varió $c$ en el rango $[5.0,\, 6.0]$ con paso de $0.02$ (51 puntos).
	
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.75\textwidth]{hamming_vs_c.png}
		\caption{Distancia de Hamming vs parámetro $c$ de Rössler}
		\label{fig:hamming_c}
	\end{figure}
	
	\subsubsection{Barrido del Parámetro $a_{\text{log}}$ del Mapa Logístico}
	
	Se varió $a_{\text{log}}$ en el rango $[3.70,\, 4.00]$ con paso de $0.01$ (31 puntos). En este caso la sincronización de Rössler se mantiene fija (se reutiliza $x_{\text{sinc}}$ ya calculado) y solo se regenera el vector logístico con el nuevo valor de $a_{\text{log}}$.
	
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.75\textwidth]{hamming_vs_aLog.png}
		\caption{Distancia de Hamming vs parámetro $a_{\text{log}}$ del mapa logístico}
		\label{fig:hamming_aLog}
	\end{figure}
	
	\subsubsection{Barrido del Parámetro $x_0$ del Mapa Logístico}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.75\textwidth]{hamming_vs_x0_log.png}
		\caption{Distancia de Hamming vs condición inicial $x_0$ del mapa logístico}
		\label{fig:hamming_x0}
	\end{figure}
