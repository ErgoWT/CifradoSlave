...
\textbf{Generación:} Se calculan histogramas de 256 bins sobre los valores de intensidad (rango $[0, 255]$) del vector cifrado y del vector descifrado. Ambos vectores corresponden al arreglo aplanado completo de la imagen RGB de $250 \times 250$ píxeles ($250 \times 250 \times 3 = 187{,}500$ valores escalares, uno por canal y por píxel). Los histogramas se grafican en subplots comparativos; se analiza el vector completo sin separar por canal.
...
\]
donde $b_i$ son los bits del vector aplanado de píxeles (187{,}500 valores uint8, es decir $N = 187{,}500 \times 8 = 1{,}500{,}000$ bits en total). Los resultados se grafican como curvas $d_H$ vs perturbación para cada parámetro.
